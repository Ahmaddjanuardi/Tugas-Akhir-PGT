<template>
  <div class="container">
    <div class="loginPage">
      <img src="@/assets/img/ktp.png" alt="" />
      <div class="main">
        ...
        <div class="login">
          <form @submit.prevent="login">
            ...
            <p class="success" v-if="registerBerhasil">
...
.loginPage {
  ...
  background: linear-gradient(to bottom, #8bbccc, #f0dbdb, #8bbccc);
}
.main {
  width: 550px;
  height: 500px;
  background: red;
  overflow: hidden;
  background: #8bbccc no-repeat center/ cover;
  border-radius: 10px;
